...
<html>
	<head>
		<meta charset="UTF-8">
    	<title>Admin | Photo 4 Approval </title>
								...
								<div class="row">
									<div class="col-lg-3 col-xs-12 col-sm-4">
										<a href="photo4_approval.php?photo_status=all" class="btn btn-success btn-lg btn-block">
											<i class="fa fa-list"></i>All Photo4 <span class="badge">
									...
									<div class="col-lg-3 col-xs-12 col-sm-4">
										<a href="photo4_approval.php?photo_status=approved" class="btn btn-success btn-lg btn-block">
											<i class="fa fa-thumbs-up"></i>Approved Photo4 <span class="badge">
									...
									<div class="col-lg-3 col-xs-12 col-sm-4">
										<a href="photo4_approval.php?photo_status=unapproved" class="btn btn-success btn-lg btn-block">
											<i class="fa fa-thumbs-down"></i>Unapproved Photo4 <span class="badge">
											<?php echo getRowCount("SELECT count(index_id) FROM register WHERE photo4 !='' AND photo4_approve='UNAPPROVED'",$DatabaseCo);?></span>
										</a>
									</div>
									<div class="col-lg-3 col-xs-12 col-sm-4">
										<a href="photo4_approval.php?photo_status=pending" class="btn btn-success btn-lg btn-block">
											<i class="fa fa-clock-o"></i>Pending Photo 4 <span class="badge">
											<?php echo getRowCount("SELECT count(index_id) FROM register WHERE photo4 !='' AND photo4_approve='PENDING'",$DatabaseCo);?></span>
										</a>
									</div>
								</div>
							</div>
											...
											<tbody>
												...
												<tr>
													...
													<?php
														...
														}elseif($DatabaseCo->dbRow->photo4_approve=="PENDING"){
