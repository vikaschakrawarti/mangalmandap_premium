...
<html>
	<head>
    	<meta charset="UTF-8">
    	<title>Admin | All Sub Caste </title>
  	...
  	<body class="skin-blue">
			...
			<!-- /. Header & Menu -->
      		<div class="content-wrapper">
				<section class="content-header">
					<h1 class="lightGrey">Add Sub Caste</h1>
				  	<ol class="breadcrumb">
						<li>
					  		<a href="dashboard">
								...
								<div class="row">
									...
									<div class="col-lg-3 col-xs-12 col-sm-4">
										<a href="updateWebSiteSubCaste?sub_caste_status=approved" class="btn btn-success btn-lg col-xs-12">
											<i class="fa fa-thumbs-up"></i>Approved Sub Caste
											<span class="badge">
									...
									<div class="col-lg-3 col-xs-12 col-sm-4">
										<a href="updateWebSiteSubCaste?sub_caste_status=unapproved" class="btn btn-success btn-lg col-xs-12">
											<i class="fa fa-thumbs-down"></i>Unapproved Sub Caste
											<span class="badge">
											...
											<tbody>
												...
												<tr>
													<td>
														...
														<label for="Item <?php  echo $DatabaseCo->dbRow->sub_caste_id;?>" class="label2">&nbsp;</label>   
													</td>
													<td>
    	...
    	<div class="md-modal" id="modal-13">
			<div class="md-content" id="dialog">
				<div class="modal-header" >
					...
					<h4 class="modal-title" id="dialog_title">Add New Sub Caste</h4>
				</div>
				...
				<form method="post" id="sub-caste-form" action="" method="post">
					<div class="modal-body gtSiteChangeId">
						<div class="form-group">
							<label for="exampleInputEmail1">Sub Caste Name</label>
						...
						<div class="form-group">
							...
							<div class="radio">
								...
								<label for="optionsRadios2" class="mr-10">Inactive </label>
							</div>
						</div>
					</div>
		...
		<script type="text/javascript">
			setPageContext("add-new","subcaste");
		</script>
    	...
    	<script type="text/javascript">
     		$(function () {
				...
				$(document).on("click", ".add-details", function () {
					...
					$("#dialog_title").text("Add New Sub Caste");
				...
				$(document).on("click", ".edit-popup", function () {
					...
					$("#save").val("Update");
					$("#dialog_title").text("Update Sub Caste");
