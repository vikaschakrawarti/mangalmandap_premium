...
<html>
	<head>
    	<meta charset="UTF-8">
    	<title>Admin | All Religion </title>
   	...
   	<body class="skin-blue">
			...
			<!-- /. Header & Menu -->
         	<div class="content-wrapper">
            	<section class="content-header">
               		<h1 class="lightGrey">Add Religion</h1>
               		<ol class="breadcrumb">
									...
									<form method="post" action="updateWebSiteReligion" id="action_form">
										<table id="example1" class="table table-bordered table-striped">
											...
											<tbody>
												...
												<tr>
													<td>
														<input type="checkbox" name="religion_id[]" id="Item <?php  echo $DatabaseCo->dbRow->religion_id;?>" class="second" value="<?php echo $DatabaseCo->dbRow->religion_id;?>"/>
														<label for="Item <?php  echo $DatabaseCo->dbRow->religion_id;?>" class="label2">&nbsp;</label>	
													</td>
													<td>
														<a class="btn btn-default btn-sm md-trigger edit-popup"  href="javascript:;" data-modal="modal-13" data-id="<?php  echo $DatabaseCo->dbRow->religion_id;?>" data-rel_name="<?php  echo $DatabaseCo->dbRow->religion_name;?>" data-rel_status="<?php  echo $DatabaseCo->dbRow->status;?>">	<i class="fas fa-pen fa-fw"></i><span class="hidden-xs">&nbsp;&nbsp;Edit</span>
														</a>
													</td>
													<?php
														$likeDisLikeCss = "";
		...
		<div class="md-modal" id="modal-13">
			<div class="md-content gtSiteChangeId" id="dialog">
