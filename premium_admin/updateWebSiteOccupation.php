...
<html>
	<head>
    	<meta charset="UTF-8">
    	<title>Admin | All Occupation </title>
							...
							<div class="box-top updateSite">
								<div class="row">
									<div class="col-lg-3 col-sm-4">
										<a class="md-trigger btn btn-default btn-lg btn-block add-details" href="javascript:;" data-modal="modal-13"> <i class="fa fa-plus"> </i>Add Occupation </a>
									</div>
									<div class="col-lg-3 col-xs-12 col-sm-4">
										<a href="updateWebSiteOccupation?occupation_status=all" class="btn btn-success btn-lg col-xs-12">
											<i class="fa fa-list"></i>All Occupation
											<span class="badge">
									...
									<div class="col-lg-3 col-xs-12 col-sm-4">
										<a href="updateWebSiteOccupation?occupation_status=approved" class="btn btn-success btn-lg col-xs-12">
											<i class="fa fa-thumbs-up"> </i>Approved Occupation
											<span class="badge">
									...
									<div class="col-lg-3 col-xs-12 col-sm-4">
										<a href="updateWebSiteOccupation?occupation_status=unapproved" class="btn btn-success btn-lg col-xs-12">
											<i class="fa fa-thumbs-down"> </i>Unapproved Occupation
											<span class="badge">
								...
								<div class="col-lg-12 col-xs-12 col-sm-12 mt-10 mb-15">
									<div class="box-top">
										<div class="row">
											...
											<div class="col-lg-2 col-xs-12 col-sm-4">
												<a href="javascript:;" class="btn btn-success btnTheme1 btn-block" onclick="submitActionForm('APPROVED');"> <i class="fa fa-thumbs-up"> </i>Approve </a>
											</div>
											<div class="col-lg-2 col-xs-12 col-sm-4">
												<a href="javascript:;" class="btn btn-warning btnTheme1 btn-block" onclick="submitActionForm('UNAPPROVED');"> <i class="fa fa-thumbs-down"> </i>Unapprove </a>
											</div>
										</div>
									</div>
								</div>
													...
													<tbody>
														...
														<tr>
															<td>
																...
																<label for="Item <?php  echo $DatabaseCo->dbRow->ocp_id;?>" class="label2">&nbsp; </label>
															</td>
															<td>
															...
															<td class="updateSite">
																<span class="textUpdate"> <?php  echo $DatabaseCo->dbRow->ocp_name;?> </span>
															</td>
														</tr>
														<?php } ?>
													</tbody>
   		...
   		<div class="md-modal" id="modal-13">
      		<div class="md-content" id="dialog">
       		 	<div class="modal-header" >
          			...
          			<h4 class="modal-title" id="dialog_title">Add New Occupation</h4>
        		</div>
