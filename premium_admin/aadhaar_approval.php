  	...
  	<body class="skin-blue">
								...
								<div class="row">
									<div class="col-lg-3 col-xs-12 col-sm-4">
										<a href="aadhaar_approval.php?aadhaar_status=all" class="btn btn-success btn-lg btn-block">
											<i class="fa fa-list"></i>All Documents <span class="badge">
									...
									<div class="col-lg-3 col-xs-12 col-sm-4">
										<a href="aadhaar_approval.php?aadhaar_status=approved" class="btn btn-success btn-lg btn-block">
											<i class="fa fa-thumbs-up"></i>Approved Documents <span class="badge">
									...
									<div class="col-lg-3 col-xs-12 col-sm-4">
										<a href="aadhaar_approval.php?aadhaar_status=unapproved" class="btn btn-success btn-lg btn-block">
											<i class="fa fa-thumbs-down"></i>Unapproved Documents <span class="badge">
									...
									<div class="col-lg-3 col-xs-12 col-sm-4">
										<a href="aadhaar_approval.php?aadhaar_status=pending" class="btn btn-success btn-lg btn-block">
											<i class="fa fa-thumbs-down"></i>Pending Documents <span class="badge">
											...
											<tbody>
												...
												<tr>
                                                    ...
                                                    <?php
														...
														}elseif($DatabaseCo->dbRow->aadhaar_card_status=="PENDING"){
		...
		<div class="modal fade-in" id="myModal6" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
			...
			<script type="text/javascript">
				...
				function GetAadhaar(toid, photoid) {
					$("#myModal6").html("Please wait...");
					$.get("./web-services/get_aadhaar?frmid=" + toid + "&photoid=" + photoid, function(data) {
						$("#myModal6").html(data);
					});
				}
			</script>
