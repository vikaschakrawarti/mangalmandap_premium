			...
			<!-- /. Header & Menu -->
      		<div class="content-wrapper">
                <section class="content-header">
                    <h1 class="lightGrey">Express Interest </h1>
                    <ol class="breadcrumb">
                        <li>
                            <a href="dashboard"><i class="fa fa-home"></i> Home</a>
                        </li>
                        <li class="active"> Express Interest </li>
                    </ol>
                </section>
                <!-- Main content -->
              	                ...
              	                <div class="row">
                                    <div class="col-lg-3 col-xs-12 col-sm-4">
                                        <a href="memberExpInterestDetail?express_status=all" class="btn btn-success btn-lg btn-block">
                                            <i class="fa fa-list"></i>All Express Interest <span class="badge"><?php echo getRowCount("SELECT count(ei_id) FROM expressinterest",$DatabaseCo);?></span>
                                        </a>
                                    </div>
                                </div> 
                            </div>
                        ...
                        <div class="col-xs-12 mt-10">
                            <div class="box box-success">
                                <div class="box-header">
                                    <h4><?php echo strtoupper($express_status); ?> EXPRESS INTEREST LIST</h4>
                                </div>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <label for="Item <?php  echo $DatabaseCo->dbRow->ei_id;?>" class="label2">&nbsp;</label>	
                                                    </td>
                                                    <td>
