...
<html>
	<head>
		<meta charset="UTF-8">
    	<title>Admin | Active to Paid </title>
							...
							<div class="box-top updateSite">
								<div class="row">
									...
									<?php 
										...
										?>
									<div class="col-lg-2 col-xs-12 col-sm-6">
										<a class="btn btn-success btn-lg btn-block add-details"  href="?clear-filter">
										<i class="fa fa-times-circle"></i>Clear Filter
										</a>
									</div>
									<?php }else{?>
									<div class="col-lg-2 col-xs-12 col-sm-6">
										<a class="btn btn-success btn-lg btn-block add-details"  data-toggle="modal" data-target="#modal-13">
