...
$result = mysqli_query($DatabaseCo->dbLink,"SELECT register.photo1,register.gender,online_users.username,online_users.index_id FROM online_users,register where register.index_id =online_users.index_id and online_users.gender!='$gen'");
...
while($row=mysqli_fetch_array($result))
{
	...
	<div class="geoRow">
		...
		<div><img src="my_photos/<?php if($row['photo1']!=''){echo $row['photo1']; }
