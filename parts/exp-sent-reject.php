...
?>
	<div class="col-xxl-16 col-xl-16 text-center">
    	<h2 class="inPageTitle fontMerriWeather inThemeOrange"><?php echo $lang['Express Interest Sent Rejected']; ?></h2>
       	<article class="gt-margin-bottom-20">
        	<p class="inPageSubTitle"><?php echo $lang['Here you can see your all express interest which you send and rejcted by members']; ?>.</p>
      	</article>
	</div>
	...
	<div class="gt-exp-strip">
		<label class="col-xxl-1 col-xl-1 col-lg-1 col-xs-2 hidden-xs hidden-sm hidden-md" for="exp-rec-all-1">
			<input type="checkbox" id="exp-rec-all-1 gt-cursor" onchange="checkAllreject(this);"> </label>
			...
			<div class="col-xxl-16 col-xl-16 col-sm-16 col-md-16 col-lg-16 hidden-xs hidden-sm hidden-md">
				<div class="row">
					<label class="col-lg-8 col-md-16 col-xxl-16 col-xl-8 col-xs-16 col-sm-16 gt-margin-bottom-0">
						<input type="checkbox" id="exp_sent_id" class="ne-cursor" name="exp_sent_pending_id" value="<?php echo $Row->ei_id;?>"> </label>
				</div>
			</div>
