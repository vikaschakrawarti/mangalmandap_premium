	...
	<div class="row">
    	<div class="col-xxl-8 col-xl-8 col-lg-8 col-md-16 col-sm-16 col-xs-16 pb-10 pt-10 gt-view-detail">
      		<div class="row">
        		...
        		<div class="col-xs-10">
          			<b>
					<?php
						if(isset($DatabaseCo->dbRow->height) && $DatabaseCo->dbRow->height !==''){
							$SQL_STATEMENT_HEIGHT =  $DatabaseCo->dbLink->query("SELECT * FROM height WHERE id='".$DatabaseCo->dbRow->height."'");
    	...
    	<div class="col-xxl-8 col-xl-8 col-lg-8 col-md-16 col-sm-16 col-xs-16 pb-10 pt-10 gt-view-detail">
      		<div class="row">
        		...
        		<div class="col-xs-10">
          			<b> <?php echo $DatabaseCo->dbRow->weight.' Kg'; ?>  </b>
        		</div>	
      		</div>
    	</div>
		<?php } ?>  
    	...
    	<div class="col-xxl-8 col-xl-8 col-lg-8 col-md-16 col-sm-16 col-xs-16 pb-10 pt-10 gt-view-detail">
      		<div class="row">
        		...
        		<div class="col-xs-10">
          			<b><?php if($DatabaseCo->dbRow->bodytype!=''){ echo $DatabaseCo->dbRow->bodytype; }else{ echo "Not Available";}?></b>
       			</div>	
      		</div>
    	</div>
		<?php } ?>  
		...
		<div class="col-xxl-8 col-xl-8 col-lg-8 col-md-16 col-sm-16 col-xs-16 pb-10 pt-10 gt-view-detail">
			<div class="row">
				...
				<div class="col-xs-10">
			  		<b><?php if($DatabaseCo->dbRow->complexion!=''){ echo $DatabaseCo->dbRow->complexion; }else{ echo "Not Available";}?></b>
				</div>	
		  	</div>
		</div>
		<?php } ?>
		...
		<div class="col-xxl-8 col-xl-8 col-lg-8 col-md-16 col-sm-16 col-xs-16 pb-10 pt-10 gt-view-detail">
			<div class="row">
				...
				<div class="col-xs-10">
			  		<b><?php if($DatabaseCo->dbRow->physicalStatus!=''){ echo $DatabaseCo->dbRow->physicalStatus; }else{ echo "Not Available";}?></b>
				</div>	
		  	</div>
		</div>
		<?php } ?>
