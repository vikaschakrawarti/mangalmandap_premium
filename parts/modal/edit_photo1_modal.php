  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header text-center">
       	<div class="col-12">
        	<h5 class="modal-title" id="exampleModalLabel"><?php echo $lang['Edit Profile Picture']; ?>
       	...
       	<form action="" method="post" enctype="multipart/form-data" class="editPhotoModal">
        	...
        	<div class="col-xxl-10 col-xxl-offset-3">
				<center>
   				...
   				<?php }else{?>
   					<?php if($Row->gender =='Female'){ ?>
   						<img src="img/female.jpg" class="img-fluid img-thumbnail" id="photo1_prev">
					<?php }else{ ?>
 						<img src="img/male.jpg" class="img-fluid img-thumbnail" id="photo1_prev">
  					<?php } ?>
   				<?php }?>
				...
				<div class="form-group text-center mt-3">
					<input type="submit" name="editPhoto1" value="<?php echo $lang['SUBMIT']; ?>" class="btn gt-btn-green btn-block gt-margin-top-20">
				</div>
				</center>
       		</div>
        </form>
