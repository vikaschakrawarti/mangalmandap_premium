<?php      
	...
	elseif(isset($_POST['user_id']))
	{
        ...
        $DatabaseCo->dbResult1=$DatabaseCo->dbLink->query($SQL_STATEMENT);
        $DatabaseCo->dbRow1 = mysqli_fetch_object($DatabaseCo->dbResult1);
	}
{
    //photo 
    ...
    if(isset($_SESSION['user_id']))
	{
		...
		$res_stat = $DatabaseCo->dbRow->residenceresidence; 
	}
	else
	{
	...
	else
	{
		...
		{
			$part_frm_age = $_POST['pfromage'];
		}
		else
		{
			$part_frm_age = '';	
		}
		if(isset($_POST['ptoage']))
		{
			$part_to_age = $_POST['ptoage'];
		}
		else
		{
			$part_to_age = '';
		}
		if(isset($_POST['preligion']))
		{
			$part_religion = $_POST['preligion'];
		}
		else
		{
			$part_religion = '';
		}
		if(isset($_POST['pcaste']))
		{
			$part_caste = $_POST['pcaste'];
		}
		else
		{
			$part_caste = '';
		}
		if(isset($_POST['pfronheight']))
		{
			$part_height = $_POST['pfronheight'];
		}
		else
		{
			$part_height = '';	
		}
		if(isset($_POST['ptoheight']))
		{
			$part_height_to = $_POST['ptoheight'];
		}
		else
		{
			$part_height_to = '';	
		}
		if(isset($_POST['pcomplexion']))
		{
			$part_complexation = $_POST['pcomplexion'];
		}
		else
		{
			$part_complexation = '';	
		}
		if(isset($_POST['peducation']))
		{
			$part_edu = $_POST['peducation'];
		}
		else
		{
			$part_edu = '';	
		...
		{
			$part_country_living = $_POST['pcountry'];
		}
		else
		{
			$part_country_living = '';	
		...
		if(isset($_POST['pmothertongue']))
		{
			$part_mtongue = $_POST['pmothertongue'];
		}
		else
		{
			$part_mtongue = '';
	...
	{
		$fname = $DatabaseCo->dbRow1->firstname;
		$lname = $DatabaseCo->dbRow1->lastname;
		$mstatus = $DatabaseCo->dbRow1->m_status;
		$mtongue = $DatabaseCo->dbRow1->m_tongue;
		$bdate = $DatabaseCo->dbRow1->birthdate;
		$state = $DatabaseCo->dbRow1->state_id;
		$city = $DatabaseCo->dbRow1->city;
		$country = $DatabaseCo->dbRow1->country_id;
		$mobile = $DatabaseCo->dbRow1->mobile;
		$religion = $DatabaseCo->dbRow1->religion;
		$caste = $DatabaseCo->dbRow1->caste;
	}
}
        // Photo 1 as 5% value
