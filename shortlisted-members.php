    					...
    					<div class="row">
							<aside class="col-xxl-12 col-xxl-offset-4 col-xl-12 col-xl-offset-4 text-center mb-20">
								<h3 class="inPageTitle fontMerriWeather inThemeOrange">
								   <?php echo $lang['Shortlisted Member Profile']; ?>
								</h3>
								<article><p class="inPageSubTitle"><?php echo $lang['You can check all of your shortlisted members list here']; ?>.</p></article>
							</aside>
