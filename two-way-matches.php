					...
					<div class="container">
						<div class="row">
							...
							<div class="col-xxl-12 col-xl-12 col-xs-16">
								<h3 class="inPageTitle fontMerriWeather inThemeOrange text-center"><?php echo $lang['Two Way Match']; ?></h3>
								<article class="text-center">
									<p class="inPageSubTitle mb-20">
										<?php echo $lang['Two way match is the profile show in perticular criteria at its best.its help you to find out your life partner easily']; ?>.
									</p>
								</article>                 
